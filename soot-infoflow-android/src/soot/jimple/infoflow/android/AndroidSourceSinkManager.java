...
//modified by szy
	public Map<String, AndroidMethod> sourceMethods;
	public final Map<String, AndroidMethod> sinkMethods;
	public final Map<String, AndroidMethod> callbackMethods;
	
	//szy
	public static Set<Unit> dynamicSinks = new HashSet<Unit>();
	public static Set<Unit> dynamicSources = new HashSet<Unit>();
	...
	{
		//szy
		if(dynamicSinks.contains((Unit)sCallSite)){
			return true;
		}
	...
	public SourceType getSourceType(Stmt sCallSite, InterproceduralCFG<Unit, SootMethod> cfg) {
		...
		//added by szy
		if(Infoflow.changeSet.contains(sCallSite)){
			return SourceType.Change;
		}
		if(dynamicSources.contains((Unit)sCallSite)){
